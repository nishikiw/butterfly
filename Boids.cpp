...
//    Min and max values ------------|--|
      ...
      k1_spinner->set_float_limits(0.0, 1.0, GLUI_LIMIT_CLAMP);
      ...
      k2_spinner->set_float_limits(0.0, 1.0, GLUI_LIMIT_CLAMP);
      ...
      k3_spinner->set_float_limits(0.0, 1.0, GLUI_LIMIT_CLAMP);
      ...
      g_spinner->set_speed(5.0);
			g_spinner->set_float_limits(-360, 360, GLUI_LIMIT_CLAMP);
...
/***** Scene drawing start *********/
    ...
    glLoadIdentity();
		glRotatef(global_rot, 0.0, 1.0, 0.0);
 ...
 */
 ...
 GLUquadric *rightWing1;	// Define a quadric() object
 ...
 gluCylinder(body,0.15,0.15,1,50,50);
 glPopMatrix();
	
 rightWing1=gluNewQuadric();	// Create a new quadric
 ...
 glColor4f(Boid_Color[i][0],Boid_Color[i][1],Boid_Color[i][2],1);	// This specifies colour as R,G,B,alpha.
 ...
 glPushMatrix();	// Save current transformation matrix
  ...
  glTranslatef(Boid_Location[i][0],Boid_Location[i][1],Boid_Location[i][2]);
	glRotatef(degree, 0, 1, 0);
	glRotatef(-90, 1, 0, 0);
	glRotatef(-Boid_Rotation[i], 0, 1, 0);
  gluPartialDisk(rightWing1,0,3,50,50, 30,60);	// Draw this boid
	glPopMatrix();		// Restore transformation matrix so it's
			// ready for the next boid.
 
 GLUquadric *leftWing1;
 leftWing1=gluNewQuadric();
 glColor4f(Boid_Color[i][0],Boid_Color[i][1],Boid_Color[i][2],1);
 glPushMatrix();
 glTranslatef(Boid_Location[i][0],Boid_Location[i][1],Boid_Location[i][2]);
 glRotatef(degree, 0, 1, 0);
 glRotatef(-90, 1, 0, 0);
 glRotatef(Boid_Rotation[i], 0, 1, 0);
 gluPartialDisk(leftWing1,0,3,50,50, -30, -60);
 glPopMatrix();
 
 GLUquadric *rightWing2;
 rightWing2=gluNewQuadric();
 glColor4f(Boid_Color[i][0],Boid_Color[i][1],Boid_Color[i][2],1);
 glPushMatrix();
 glTranslatef(Boid_Location[i][0],Boid_Location[i][1],Boid_Location[i][2]);
 glRotatef(degree, 0, 1, 0);
 glRotatef(-90, 1, 0, 0);
 glRotatef(-Boid_Rotation[i], 0, 1, 0);
 gluPartialDisk(rightWing2,0,2,50,50, 95, 75);
 glPopMatrix();
 
 GLUquadric *leftWing2;
 leftWing2=gluNewQuadric();
 glColor4f(Boid_Color[i][0],Boid_Color[i][1],Boid_Color[i][2],1);
 glPushMatrix();
 glTranslatef(Boid_Location[i][0],Boid_Location[i][1],Boid_Location[i][2]);
 glRotatef(degree, 0, 1, 0);
